...
class App {
    ...
    _setupModel() {
        ...
        shMesh.scale.set(3, 3, 3);
        shOrbit.position.x = 36;
        shOrbit.add(shMesh);
        ...
        shMesh2.scale.set(4.5, 4.5, 4.5);
        shOrbit2.position.x = 36;
        ...
        shMesh3.scale.set(4.5, 4.5, 4.5);
        shOrbit3.position.x = 36;
    ...
    update(time) {
        ...
        this._shOrbit2.rotation.y += 0.01;
        this._shOrbit3.rotation.y += 0.005;
